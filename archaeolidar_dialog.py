...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'archaeolidar_dialog_base.ui'))


class archaeolidarDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(archaeolidarDialog, self).__init__(parent)
